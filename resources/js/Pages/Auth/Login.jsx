        ...
        <div className="flex justify-center items-center h-screen">
            ...
            <div className="z-10 flex flex-col justify-between gap-20 border shadow-xl w-1/3 py-14 px-10 backdrop-blur-sm rounded-lg">
                ...
                <div className="flex flex-col items-end gap-5">
                    <button className="text-xl text-white font-bold text-center py-2 bg-green-button rounded shadow-xl w-40 hover:bg-green-button-darker trasnform duration-200">Login</button>
