    ...
    return(
        <GuestLayout>
            ...
            <div className='p-5 grid grid-cols-2 lg:grid-cols-3 gap-5'>
                <Link className='flex justify-between gap-8 h-32 border p-3 shadow-2xl transform duration-150 rounded-tl rounded-tr border-b-4 border-b-green-500 hover:bg-gray-100'>
                ...
                <Link className='flex justify-between gap-8 h-32 border p-3 shadow-2xl transform duration-150 rounded-tl rounded-tr border-b-4 border-b-indigo-500 hover:bg-gray-100'>
